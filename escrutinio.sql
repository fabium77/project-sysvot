...
INSERT INTO `agrupacionespoliticas` VALUES (1,'Frente de Todos',503,NULL,NULL),(2,'Juntos Frente por el cambio',506,NULL,NULL),(5,'borrarr',123,'2019-10-07 18:15:20','2019-10-07 18:15:31');
/*!40000 ALTER TABLE `agrupacionespoliticas` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `agrupoliticas`
--

DROP TABLE IF EXISTS `agrupoliticas`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `agrupoliticas` (
  `idAgrupacionesPoliticas` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `agrupoliticas`
--

LOCK TABLES `agrupoliticas` WRITE;
/*!40000 ALTER TABLE `agrupoliticas` DISABLE KEYS */;
/*!40000 ALTER TABLE `agrupoliticas` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `cargoselectivos` VALUES (1,'Presidente',1,1),(2,'Gobernador',1,1),(3,'Senador',1,1),(4,'Intendecia',1,1);
...
INSERT INTO `circuitos` VALUES (1,'san isidro','72',8);
...
INSERT INTO `comicios` VALUES (1,'paso','2019-08-11',1);
...
INSERT INTO `comicios_has_mesas` VALUES (1,1,1,500);
...
INSERT INTO `escuelas` VALUES (1,'Esc. Muni N1','direccion',1);
...
INSERT INTO `listainterna_has_cargoselectivos` VALUES (1,1,2),(2,1,3),(3,1,4),(4,2,2),(5,2,3),(6,2,4);
...
INSERT INTO `listainternas` VALUES (1,'Frente de Todos',503,1,'B'),(2,'Frente de Todos',503,1,'C'),(3,'Frente de Todos',503,1,'A'),(4,'Juntos por el Cambio',506,2,'A');
...
INSERT INTO `mesas` VALUES (1,589,1),(2,590,1);
...
INSERT INTO `role_user` VALUES (1,1,1,NULL,NULL),(2,3,2,'2019-10-07 22:24:58','2019-10-07 22:24:58'),(3,3,3,'2019-10-08 22:13:08','2019-10-08 22:13:08');
...
INSERT INTO `roles` VALUES (1,'Admin','admin','Role administrador','2019-10-04 15:14:28','2019-10-04 15:14:29','all-access'),(2,'Suspendido','suspendido','Usuarios temporalmente inavilitados',NULL,NULL,'no-access'),(3,'Operador','operador.sistemas','Carga de Circuitos, Locales y mesas de votacion','2019-10-07 22:21:49','2019-10-07 22:21:49',NULL);
...
INSERT INTO `secciones` VALUES (8,'Valle Viejo',1),(14,'Chilecito',2);
...
INSERT INTO `tiposcargoselectivos` VALUES (1,1,0);
...
INSERT INTO `users` VALUES (1,'Fabio Molina','fabium77@gmail.com',NULL,'$2y$10$Woz/3/TxyYEYBE9kOWsg6uMLxAyfWA8snQ7OK8PEap/RHVTkCElfy',NULL,'2019-10-04 18:12:32','2019-10-04 18:12:32'),(2,'OperadorPrueba','operador@gmail.com',NULL,'$2y$10$ShFeh3niyp5PI9cyQ5CP6.lYUck0LP8C4ZGJQva851w7z4Zt7I0Mq',NULL,'2019-10-07 22:24:04','2019-10-07 22:24:04'),(3,'OperadorPrueba2','operador2@gmail.com',NULL,'$2y$10$3SOvzQH29WA7zS4v9ENYZOtOtlwAKuhceP7hQ44EVX49PcLKkHqoS',NULL,'2019-10-08 22:12:40','2019-10-08 22:12:40');
...
-- Dump completed on 2019-10-08 16:55:25
